...
irrBullet/%.o: ../irrBullet/%.cpp
	...
	g++ -I../src -I../src/classes -I../irrBullet -I/home/lisa/libs/irrlicht-1.8/include -I/home/lisa/libs/bullet-2.79/install/include/bullet -I/home/lisa/libs/OALwrapper/include -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
